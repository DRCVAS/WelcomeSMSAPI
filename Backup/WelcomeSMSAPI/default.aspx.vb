...
Public Class _default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ElseIf cos = "62" Then
            reply = "Bienvenue chez Africell! Votre numéro 0" & number.Substring(3) & " a reçu 10 SMS africell-africell.Tapez *111*100# pour vérifier votre Solde"
        ElseIf cos = "66" Then
            reply = "Cher client, pour cet achat du modem africell, votre numéro 0" & number.Substring(3) & " a reçu 2 GB valide pour 30 jours. Pour vérifier votre balance faite le *111*100#"
        ElseIf cos = "82" Then
            reply = "Bien aimé dans le seigneur! Votre numéro 0" & number.Substring(3) & " a reçu 4u Africell-Africell."
        ElseIf cos = "147" Then
